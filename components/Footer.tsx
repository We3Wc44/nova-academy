      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-2">Nova Academy</h3>
            <p className="text-gray-400 max-w-sm">Empowering the next generation of creators, thinkers, and leaders through accessible, high-quality online education.</p>
          </div>
          <div>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 text-center text-gray-500">
          <p>&copy; {new Date().getFullYear()} Nova Academy. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
